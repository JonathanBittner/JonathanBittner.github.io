...
/*map.addSource("file80", {
  ...
  */
	...
	map.setPaintProperty('us-40s-major', 'line-color', colors.signed.major.mainline[4]);
    map.setPaintProperty('us-40s-major','line-width', defaultLineWidth);
	
	map.setPaintProperty('us-30s-major', 'line-color', colors.signed.major.mainline[3]);
    map.setPaintProperty('us-30s-major','line-width', defaultLineWidth);
	...
	map.setFilter('us-quadruplex-1',['all', ["==", ["get", "route0_status"], "signed"], ["==", ["get", "route1_status"], "signed"], ["==", ["get", "route2_status"], "signed"], ["==", ["get", "route3_status"], "signed"], 
	["==", ["get", "route0_role"], "mainline"], ["==", ["get", "route1_role"], "mainline"],	["==", ["get", "route2_role"], "mainline"], ["==", ["get", "route2_role"], "mainline"]]);
	...
	map.setFilter('us-quadruplex-2',['all', ["==", ["get", "route0_status"], "signed"], ["==", ["get", "route1_status"], "signed"], ["==", ["get", "route2_status"], "signed"], ["==", ["get", "route3_status"], "signed"], 
	["==", ["get", "route0_role"], "mainline"], ["==", ["get", "route1_role"], "mainline"],	["==", ["get", "route2_role"], "mainline"], ["==", ["get", "route2_role"], "mainline"]]);
	...
	map.setFilter('us-quadruplex-3',['all', ["==", ["get", "route0_status"], "signed"], ["==", ["get", "route1_status"], "signed"], ["==", ["get", "route2_status"], "signed"], ["==", ["get", "route3_status"], "signed"], 
	["==", ["get", "route0_role"], "mainline"], ["==", ["get", "route1_role"], "mainline"],	["==", ["get", "route2_role"], "mainline"], ["==", ["get", "route2_role"], "mainline"]]);
	...
	map.setFilter('us-quadruplex-4',['all', ["==", ["get", "route0_status"], "signed"], ["==", ["get", "route1_status"], "signed"], ["==", ["get", "route2_status"], "signed"], ["==", ["get", "route3_status"], "signed"], 
	["==", ["get", "route0_role"], "mainline"], ["==", ["get", "route1_role"], "mainline"],	["==", ["get", "route2_role"], "mainline"], ["==", ["get", "route2_role"], "mainline"]]);
